...
const PasswordFailure = ({navigation}) => {
               ...
               <Header  navigation={navigation} isBackArrow={false} title="" />
                ...
                <View style={styles.deposittwo_main_top2}>
                    ...
                    <Image source={require('../../../assets/images/closewhite.png')} style={styles.deposittwo_main_top_c_img} resizeMode='contain'/>
                     ...
                     <Text style={styles.deposittwo_main_top_b3}>Password reset failed, try again</Text>
                </View>
                ...
                <View style={styles.btn_container}>
                    <TouchableOpacity style={styles.btn_wrapper_small_white} onPress={() => navigation.navigate('Dashboard')}>
