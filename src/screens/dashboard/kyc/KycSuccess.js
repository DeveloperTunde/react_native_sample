...
const KycSuccess = ({navigation}) => {

    const {fallbackRoute, isActive, userJwt, withdrawalamount} = useSelector(state => state.userReducer);
    return (
            ...
            <CustomeStatusBar 
               ...
               <Header  navigation={navigation} isBackArrow={false} title="" />
                ...
                <View style={styles.deposittwo_main_top2}>
                    ...
                    <Text style={styles.deposittwo_main_top_b3}>Email verified</Text>
                    <Text style={styles.deposittwo_main_top_b4}>You are good to go!</Text>
                </View>
                ...
                <View style={styles.btn_container}>
                    <TouchableOpacity style={styles.btn_wrapper_small_white} onPress={() => (fallbackRoute != '')? navigation.navigate(fallbackRoute):navigation.navigate('DashboardIndex')}>
                        <Text style={styles.btn_text_white}>Home </Text>
                    </TouchableOpacity>
                </View>
