...
import { View, Text, StyleSheet, Dimensions, SafeAreaView, StatusBar, ScrollView , TextInput, Pressable, Image, TouchableOpacity} from 'react-native';
          ...
          <CustomeStatusBar 
            ...
            />        
                <View style={[styles.dashboard_wrapper2, {height}]}>
                           ...
                           <Header gotoProfile={()=> navigation.navigate('Profile')} goback={()=>navigation.goBack()} title="Invest" setFirstlscan={() => setFirstLscan()}/>
                    ...
                    <View style={styles.dashboard_pay_middle}>
                        ...
                        <Text style={styles.dashboard_pay_middle_txt}>Invest directly from your bank and earn 20x more interest with the power of DeFi.</Text>
